...
def inverse_mix_single_column(column):
    ...
    transform_matrix = numpy.array([
        ...
        [0x0d, 0x09, 0x0e, 0x0b],
        [0x0b, 0x0d, 0x09, 0x0e]
    ], dtype=numpy.uint8)  # 9, 11, 13, and 14 :: 09, 0b, 0d, 0e
...
if __name__ == '__main__':
    ...
    key = numpy.array([[0x2b, 0x7e, 0x15, 0x16],
                       [0x28, 0xae, 0xd2, 0xa6],
                       [0xab, 0xf7, 0xcf, 0x5d],
                       [0x22, 0x1f, 0x3b, 0x30]], dtype=numpy.uint8)
    key = key.transpose()
